package com.navinfo.dataservice.openapi.edit.service.glm.ad.zone;
...
/**
 * @ClassName: ZoneFaceTopo
 * @Author shenguoqiang
 * @Date 2018/5/15 20:50
 * @Description: ZoneFaceTopo.java
 */
public class ZoneFaceTopo extends BasicRow implements IFaceTopo{

    public ZoneFaceTopo(long objPid) {
        super(objPid);
    }
